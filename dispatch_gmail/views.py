...
import getpass, os, imaplib, email, sys, gmail, dispatch_gmail
...
# Connect and Authenticate Gmail account.
...
incident_fields =  ['Unit', 'Inc', 'Venue', 'Nature', 'Xsts', 'Loc', 'Common', 'Addtl']


#Only trying to parse the emails that are relevant. Selecting by sender and subject - NO Gmail labels here.
typ, data = conn.search(None, '(FROM "messaging@iamresponding.com")'
try:
